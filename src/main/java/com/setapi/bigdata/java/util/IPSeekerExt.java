package com.setapi.bigdata.java.util;

import com.setapi.bigdata.java.common.GlobalConstants;
...
public class IPSeekerExt extends IPSeeker {
    ...
    static {
        ...
        try {
            ...
            if(Boolean.valueOf(props.getProperty("is.local"))){
                ipFilePath = props.getProperty("ip.datas.path.local");
            } else {
	...
	// 然后在这里指定全路径
	// private static final String ipFilePath = "data/qqwry.dat";
	// 部署在服务器上
